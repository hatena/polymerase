...
func (StoredType) EnumDescriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{0} }
...
type BackupMeta struct {
	...
	StoredType    StoredType `protobuf:"varint,4,opt,name=stored_type,json=storedType,proto3,enum=polypb.StoredType" json:"stored_type,omitempty"`
...
func (m *BackupMeta) GetNodeName() string {
	if m != nil {
		return m.NodeName
	}
	return ""
...
func (m *BackupMeta) GetStoredType() StoredType {
	if m != nil {
		return m.StoredType
	}
...
func (m *BackupMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StoredType != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintMetadata(dAtA, i, uint64(m.StoredType))
	}
	if m.EndTime != nil {
		dAtA[i] = 0x2a
		i++
...
func (m *BackupMeta) Size() (n int) {
	...
	if m.StoredType != 0 {
		n += 1 + sovMetadata(uint64(m.StoredType))
	}
	if m.EndTime != nil {
...
func (m *BackupMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StoredType", wireType)
			}
			m.StoredType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StoredType |= (StoredType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetadata = []byte{
	...
	,
