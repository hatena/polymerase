...
//					BackupType:  t,
//					Key:         key,
//					FileSize:    getFileSize(path.Join(fd, fs[j].Name()), base.ConvertToType(t)),
//				})
//				if t == "full-backuped" {
//					flag = true
//					break
...
//}
//
//func (s *LocalBackupStorage) RemoveBackups(cli etcd.ClientAPI, key polypb.Key) error {
//
...
//}
//
//func (s *LocalBackupStorage) GetKPastBackupPrefixKey(db polypb.DatabaseID, k int) (polypb.Key, error) {
//	spd, err := ioutil.ReadDir(fmt.Sprintf("%s/%s", s.backupsDir, db))
//	if err != nil {
//		return nil, err
//	}
//	if len(spd) < k {
//		return nil, errors.New("Not enough key to search for")
//	}
//	return keys.MakeBackupPrefixKey(db, polypb.TimePoint(spd[len(spd)-k].Name())), nil
//}
//
